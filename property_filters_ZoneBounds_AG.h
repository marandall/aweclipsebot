...
{
	class ZoneBoundsPropertyBuilder;
	...
	public: // type defenition for property builder
		typedef ZoneBoundsPropertyBuilder PropertyBuilder;
	...
	public: // file operations
		...
		{
			char* section_id = const_cast<char*>("propfilterZoneBounds");
	...
	class ZoneBoundsPropertyBuilder : public PropertyBuilderBase
	{
	...
	public: // functions
		...
		bool dialog_to_attributes(ZoneBoundsData& Attr)
		{
			data_exchange(Attr, DataExchanger::FROM_CONTROL);
			return Attr.onUpdated();
		}
		
		void attributes_to_dialog(ZoneBoundsData& Attr)
		{
			data_exchange(Attr, DataExchanger::TO_CONTROL);
		}
		
		void data_exchange(ZoneBoundsData& Attr, bool Mode)
		{
		...
		PropertyBuilderBase& assign_remote(ZoneBoundsData& RemoteData)
		{
